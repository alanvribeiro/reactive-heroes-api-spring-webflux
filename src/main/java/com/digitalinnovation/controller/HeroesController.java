...
import static com.digitalinnovation.constants.HeroesConstant.HEROES_ENDPOINT_LOCAL;
...
public class HeroesController {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public Mono<Heroes> updateHero(@RequestBody HeroesDTO heroesDTO) throws Exception {
        log.info("Hero with id {} was Updated", heroesDTO.getId());
        return heroesService.updateHero(heroesDTO);
    }
